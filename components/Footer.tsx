...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-32 bg-[#F0F0F0] pt-32">
      ...
      {/* Footer Content */}
      <div className="mx-auto max-w-[1240px] px-8 pb-8 pt-16">
        <div className="grid gap-8 lg:w-[140vmin] grid-cols-2 lg:grid-cols-5 mt-10 lg:mt-0">
          {/* Shop.co Info */}
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-gray-200 pt-8 md:flex-row">
          <p className="mb-0 text-sm text-gray-800 md:mb-0 font-poppins text-[1.6vmin] font-bold">Shop.co © 2000-2023, All Rights Reserved</p>
          <p className="mb-4 text-sm text-gray-600 md:mb-0 font-poppins text-[1.6vmin]">By Merchantsons For GIAIC - # 00037391</p>
